...
\addtolength{\textheight}{150pt} 						 % triche pour rester sur une page
...
Développeur
\begin{itemize}
	\item Amélioration d'un système de gestion de texte sur un ensemble d'images médicales
	\item Amélioration d'interface graphique java
	\item Refactoring de code C en C++
	\item Optimisation des performance sur du code C/C++ et sur des scripts bash, tcsh, sh
	\item Maintenance et débogage du code existant (gdb, valgrind)
	\item Création de script d'automatisation des taches
	\item Développement d'un framework de tests en Python
	\item Écriture de tests automatisés
	\item Animation de meeting d'intégration et réalisation de la release
\end{itemize}
Devops
\begin{itemize}
	\item Support poste Linux et machine virtuelles (CentOS, VMWares/VSphere)
	\item Maintenance d'outil de déploiement (javascript, JQuery, PHP)
	\item Réécriture d'outil de déploiement (MongoDB, Express, AngularJS, Nodejs)
	\item Mise en place d'intégration continue à l'aide de Jenkins
\end{itemize}
}
...
\cvcomputer{\textbf{S}ystèmes d'exploitation:}{GNU/Linux, Windows}{\textbf{L}ogiciel, IDE, Outils:}{Vim, Mercurial, Eclipse, Netbeans, Qt Creator, Emacs, Visual Studio, Subversion, OpenOffice, \LaTeX, Scilab, Gdb, Valgrind, Kcachegrind, Git, IBM Rational ClearQuest, Jira, Docker, VSphere}
